...
<body>
    <div class="flex justify-center items-center h-screen bg-slate-400">
        <div class="bg-white p-8 rounded-lg border border-slate-600">
            <form enctype="multipart/form-data" action="store.php" method="post" class="flex flex-col space-y-6 text-center">
                <p class="text-lg font-semibold">Insert the new category name</p>
                ...
                <p class="text-lg font-semibold">Insert the category description</p>
                ...
                <button type="submit" class="bg-blue-500 border border-gray-700 rounded-lg text-lg py-4 px-6 font-semibold text-white shadow-md shadow-black hover:-translate-y-1 duration-200">Add category</button>
            </form>
        </div>
    </div>
</body>
