        ...
        <form action="update.php" enctype="multipart/form-data" method="post">
            <div class="flex flex-col justify-center items-center space-y-3 font-semibold">
                <div id="username" class="flex flex-col justify-center items-center space-y-1">
                    <h1>Enter the new category name</h1>
                    <input value="<?= $categories[0]['name'] ?>" placeholder="name" type="text" name="name" class="border-1 border-black text-center p-2">
                </div>
                <div id="email" class="flex flex-col justify-center items-center space-y-1">
                    <h1>Enter a new description</h1>
                    <input value="<?= $categories[0]['description'] ?>" placeholder="description" type="text" name="description" class="border-1 border-black text-center p-2">
                </div>
